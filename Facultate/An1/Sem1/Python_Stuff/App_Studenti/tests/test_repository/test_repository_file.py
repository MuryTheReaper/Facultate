import unittest
from domain.entities import student, lab_prb, notare
from repository.file import file_student, file_lab, file_nota

class testcase_file_student(unittest.TestCase):
    def setUp(self):
        self.s=student("X Y","215")
        self.repo=file_student('/home/mury/Python Stuff/App_Studenti/repository/test_students.txt')
...
class testcase_file_lab(unittest.TestCase):
    def setUp(self):
        self.l=lab_prb("6_9","FP","08/11/2021")
        self.repo=file_lab('/home/mury/Python Stuff/App_Studenti/repository/test_labs.txt')
...
class testcase_file_notare(unittest.TestCase):
    def setUp(self):
        self.n=notare(1,"1_2")
        self.repo=file_nota('/home/mury/Python Stuff/App_Studenti/repository/test_note.txt')
