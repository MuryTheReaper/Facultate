...
public class ServiceManager {
    ...
    public  List<Student> findAllStudents() {
        ...
        s4.setId(4L);
        Student s5 = new Student("marian", 222);
        s4.setId(5L);
        Student s6 = new Student("mihai", 222);
        s4.setId(6L);
    ...
    private  List<Nota> getNote(List<Student> stud, List<Tema> teme) {
        return Arrays.asList(
                ...
                new Nota(stud.get(2), teme.get(3), 10d, LocalDate.of(2019, 10, 29), "profesor2"),
                new Nota(stud.get(3), teme.get(1), 10d, LocalDate.of(2019, 10, 29), "profesor2"),
                new Nota(stud.get(4), teme.get(2), 8d, LocalDate.of(2019, 10, 29), "profesor2"),
                new Nota(stud.get(5), teme.get(3), 10d, LocalDate.of(2019, 10, 29), "profesor2"),
                new Nota(stud.get(5), teme.get(2), 7d, LocalDate.of(2019, 10, 29), "profesor2")
        );
    }
